...
# TODO we'll drop this module in favor of purchase_order_line_packaging_qty. See BSALLO-880.
class PurchaseOrderLine(models.Model):
    ...
    def _compute_product_packaging_id(self):
        ...
        result = super(PurchaseOrderLine, _self)._compute_product_packaging_id()
        return result
