...
class TestPurchasePackagingLevel(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        config.purchase_packaging_level_id = cls.level1
        config.execute()
    ...
    def test_purchase_packaging_level_qty(self):
        ...
        self.assertEqual(self.purchase_order.total_transport_qty, "0.0 Pack1")
        ...
        self.assertEqual(self.purchase_order.total_transport_qty, "3.25 Pack1")
